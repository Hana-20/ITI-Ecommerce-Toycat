...
<!-- 
        <div class="slider-item" style=" background-color: fd6e00;">
          <a href=""  style=" color: white; text-decoration: none;">Action Figures</a>
        </div>

        <li class="slider-item"><img src="https://images.pexels.com/photos/286076/pexels-photo-286076.jpeg?h=240"></li>
        <li class="slider-item"><img src="https://images.pexels.com/photos/13248624/pexels-photo-13248624.jpeg?h=240">
        </li>
        ...
        <li class="slider-item"><img src="https://images.pexels.com/photos/1796730/pexels-photo-1796730.jpeg?h=240">
        </li>
        <li class="slider-item"><img src="https://images.pexels.com/photos/702343/pexels-photo-702343.jpeg?h=240"></li>
        <li class="slider-item"><img src="https://images.pexels.com/photos/1058759/pexels-photo-1058759.jpeg?h=240">
        </li>
        <li class="slider-item"><img src="https://images.pexels.com/photos/3584437/pexels-photo-3584437.jpeg?h=240">
        </li>
        <li class="slider-item"><img src="https://images.pexels.com/photos/8782716/pexels-photo-8782716.jpeg?h=240">
        </li>
